...
#' }
#' @export
gearPlotHH.dowgSH<-function(Survey,years,quarter,c.int=.9,c.inta=.8,c.intb=.8,int.type=c("prediction","confidence","both"),es=FALSE,col1="darkblue",col2="steelblue2",getICES=T,pF=T,ti=T,esc.mult=1) {
