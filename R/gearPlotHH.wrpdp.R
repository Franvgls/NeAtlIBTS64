...
#' }
#' @export
gearPlotHH.wrpdp<-function(Survey,years,quarter,incl2=TRUE,line=TRUE,c.inta=.95,int.type=c("prediction","confidence","both"),es=FALSE,col1="darkblue",getICES=TRUE,pF=TRUE,ti=TRUE) {
