...
#' }
#' @export
gearPlotHHNS.wgdp<-function(Survey="NS-IBTS",years,quarter,country,c.inta=.8,c.intb=.3,int.type=c("prediction","confidence","both"),col1="darkblue",col2="steelblue2",getICES=T,pF=T) {
